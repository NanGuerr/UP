...
### 4️⃣ Ejercicio 4: Paridad y Expresiones Algebraicas
**Consigna:**  
...
## 🧮 UNIDAD 2: Congruencias y Teoría de Números

### 5️⃣ Ejercicio 5: Ecuaciones de Congruencia Lineal
**Consigna:**  
Dada la siguiente ecuación lineal de congruencia:

$$660x \equiv 84 \pmod{546}$$

1. Analizar si posee solución analizando el Máximo Común Divisor: $\gcd(660, 546) \mid 84$.
2. En caso afirmativo, determinar la **solución general** en $\mathbb{Z}$.
3. Hallar todas las **soluciones particulares positivas menores a $546$**.



### 6️⃣ Ejercicio 6: Aritmética Modular y Restos
**Consigna:**  
Utilizar las propiedades fundamentales de la congruencia (Teorema de Fermat, simplificación modular, etc.) para hallar el resto de dividir la potencia $87^{1571}$ entre $7$:

$$87^{1571} \pmod 7$$

* **Requisito:** Enunciar explícitamente cada una de las propiedades y teoremas algebraicos utilizados en el procedimiento.



## 📐 UNIDAD 3: Álgebra Vectorial y Geometría en $\mathbb{R}^3$

### 7️⃣ Ejercicio 7: Proyección Vectorial entre Vectores
**Consigna:**  
...
$$\mathbf{Proy}_{( ec{u}+ ec{v})} ( ec{v} -  ec{u})$$

> 🛑 *Nota de corrección del docente en el parcial:* Cuidado con cometer ERROR CONCEPTUAL en el producto escalar / proyección.



### 8️⃣ Ejercicio 8: Área de Paralelogramo (Producto Vectorial)
**Consigna:**  
