...
3. **Sistema de Ecuaciones Lineales:**  
   ...
   $$\begin{cases} -b + 7d = 0 \\ a - c - 8d = 0 \\ 2b + 3c = 0 \end{cases}$$
...
3. **Expresión del Conjunto Solución:**  
   ...
   $$\begin{cases} x_1 = 0 \\ x_2 + x_3 = 0 \implies x_2 = -x_3 \end{cases}$$

   El vector solución general toma la forma:
   
   $$\begin{pmatrix} x_1 \\ x_2 \\ x_3 \end{pmatrix} = \begin{pmatrix} 0 \\ -x_3 \\ x_3 \end{pmatrix} = x_3 \begin{pmatrix} 0 \\ -1 \\ 1 \end{pmatrix}, \quad x_3 \in \mathbb{R}$$

4. **Base del Espacio Solución:**  
   
   $$\text{Base} = \left\{ \begin{pmatrix} 0 \\ -1 \\ 1 \end{pmatrix} \right\}$$
...
3. **Cálculo del Núcleo ($\ker(T)$):**  
   ...
   $$\begin{cases} 3x + z = 0 \\ -x + y = 0 \\ z = 0 \end{cases}$$
...
3. **Cálculo del Núcleo ($\ker(T)$):**  
   ...
   $$a_0 x^2 + a_1 x - a_2 = 0x^2 + 0x + 0 \implies \begin{cases} a_0 = 0 \\ a_1 = 0 \\ a_2 = 0 \end{cases}$$
