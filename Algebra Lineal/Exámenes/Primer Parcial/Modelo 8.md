...
* De la primera hipótesis se deduce que existe un entero $k \in \mathbb{Z}$ tal que:
...
* Observamos que $117^{10} \equiv 1 \pmod{11}$, lo que significa que el ciclo se repite cada $10$ potencias.
...
* O bien asignar otros valores adecuados que satisfagan el sistema y sean linealmente independientes. 🎉
