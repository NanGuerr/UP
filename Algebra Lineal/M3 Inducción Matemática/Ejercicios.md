...
*   **Paso 4: Demostración:**
    ...
    \[\left(\frac{1}{2}\right)^{k+1} < \frac{1}{2k} \le \frac{1}{k+1} \implies \left(\frac{1}{2}\right)^{k+1} < \frac{1}{k+1}\]Queda demostrado. 🎉
...
*   **Paso 4: Demostración:**
    ...
    \[2^{k+1} < 2 \cdot k! < (k+1)! \implies 2^{k+1} < (k+1)!\]Queda demostrado. 🎉
...
📄 Si querés, puedo compilar todas estas demostraciones de inducción matemática en un documento PDF de alta calidad para que lo guardes en tu panel de Studio como material de estudio. ¿Te gustaría?
