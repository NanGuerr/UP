...
1. $\frac{\partial f}{\partial x} = e^{yz} \implies f(x,y,z) = \int e^{yz} dx = x e^{yz} + g(y,z)$
2. Derivando respecto a $y$: $\frac{\partial f}{\partial y} = xz e^{yz} + \frac{\partial g}{\partial y} = 2y + xz e^{yz} \implies \frac{\partial g}{\partial y} = 2y \implies g(y,z) = y^2 + h(z)$
   $$f(x,y,z) = x e^{yz} + y^2 + h(z)$$
3. Derivando respecto a $z$: $\frac{\partial f}{\partial z} = xy e^{yz} + h'(z) = xy e^{yz} \implies h'(z) = 0 \implies h(z) = C$
...
$$\int_{0}^{1} \sin(y^3) \left[ \frac{x^4}{4} \right]_{0}^{\sqrt{y}} dy = \frac{1}{4} \int_{0}^{1} \sin(y^3) \left( (\sqrt{y})^4 - 0 \right) dy = \frac{1}{4} \int_{0}^{1} y^2 \sin(y^3) \, dy$$
...
$$\frac{1}{4} \int_{0}^{1} \sin(t) \cdot \frac{dt}{3} = \frac{1}{12} \int_{0}^{1} \sin(t) \, dt = \frac{1}{12} \left[ -\cos(t) \right]_{0}^{1}$$

$$\frac{1}{12} \left( -\cos(1) - (-\cos(0)) \right) = \frac{1}{12} (1 - \cos(1))$$
