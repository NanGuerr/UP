...
$$f(x) \sim \sum_{n=1}^{\infty} b_n \operatorname{sen}\left(\frac{n\pi x}{L}\right)$$

Donde los coeficientes se calculan como:
$$b_n = \frac{2}{L} \int_{0}^{L} f(x) \operatorname{sen}\left(\frac{n\pi x}{L}\right) dx$$
...
- **Cálculo de $a_n$ ($n \ge 1$):**
  $$a_n = \frac{2}{4} \int_{0}^{4} 9 \cos\left(\frac{n\pi x}{4}\right) dx = \frac{9}{2} \left[ \frac{4}{n\pi} \operatorname{sen}\left(\frac{n\pi x}{4}\right) \right]_{0}^{4} = \frac{18}{n\pi} (\operatorname{sen}(n\pi) - \operatorname{sen}(0))$$
  Como $\operatorname{sen}(n\pi) = 0$ para todo $n \in \mathbb{N}$, resulta $a_n = 0$.
...
- **Cálculo de $b_n$:**
  $$b_n = \frac{2}{4} \int_{0}^{4} 9 \operatorname{sen}\left(\frac{n\pi x}{4}\right) dx = \frac{9}{2} \left[ -\frac{4}{n\pi} \cos\left(\frac{n\pi x}{4}\right) \right]_{0}^{4} = -\frac{18}{n\pi} (\cos(n\pi) - \cos(0))$$
...
- **Serie de Senos resultante:**
  $$f(x) = \sum_{k=0}^{\infty} \frac{36}{(2k+1)\pi} \operatorname{sen}\left(\frac{(2k+1)\pi x}{4}\right)$$
...
- **Cálculo de $b_n$:**
  ...
  $$b_n = \frac{2}{5} \int_{0}^{5} (7x - 5x^2) \operatorname{sen}\left(\frac{n\pi x}{5}\right) dx = \frac{180(-1)^n}{n\pi} + \frac{500(1 - (-1)^n)}{n^3\pi^3}$$

- **Serie de Senos resultante:**
  $$f(x) = \sum_{n=1}^{\infty} \left[ \frac{180(-1)^n}{n\pi} + \frac{500(1 - (-1)^n)}{n^3\pi^3} \right] \operatorname{sen}\left(\frac{n\pi x}{5}\right)$$
...
- **Cálculo de $a_n$ ($n \ge 1$):**
  Usando la fórmula integral $\int e^{ax}\cos(bx)dx = \frac{e^{ax}(a\cos(bx) + b\operatorname{sen}(bx))}{a^2 + b^2}$:
...
- **Cálculo de $b_n$:**
  Usando la fórmula integral $\int e^{ax}\operatorname{sen}(bx)dx = \frac{e^{ax}(a\operatorname{sen}(bx) - b\cos(bx))}{a^2 + b^2}$:
  $$b_n = \frac{4n\pi(e^{-28}(-1)^n - 1)}{784 + n^2\pi^2}$$

- **Serie de Senos resultante:**
  $$f(x) = \sum_{n=1}^{\infty} \left( \frac{4n\pi(e^{-28}(-1)^n - 1)}{784 + n^2\pi^2} \right) \operatorname{sen}\left(\frac{n\pi x}{4}\right)$$
...
- **Serie de Senos resultante:**
  $$f(x) = \sum_{n=1}^{\infty} \left( \frac{n\pi(18750(-1)^n - 6)}{25\ln^2(5) + n^2\pi^2} \right) \operatorname{sen}\left(\frac{n\pi x}{5}\right)$$
...
- **Cálculo de $a_n$ ($n \ge 1$):**
  $$a_n = \int_{0}^{1} \cos\left(\frac{n\pi x}{2}\right) dx - \int_{1}^{2} \cos\left(\frac{n\pi x}{2}\right) dx = \frac{4}{n\pi} \operatorname{sen}\left(\frac{n\pi}{2}\right)$$
  - Si $n$ es par: $a_n = 0$.
...
- **Cálculo de $b_n$:**
  $$b_n = \int_{0}^{1} \operatorname{sen}\left(\frac{n\pi x}{2}\right) dx - \int_{1}^{2} \operatorname{sen}\left(\frac{n\pi x}{2}\right) dx = \frac{2}{n\pi} \left( 1 - 2\cos\left(\frac{n\pi}{2}\right) + (-1)^n \right)$$
  - Únicamente los términos con $n = 4m + 2$ resultan no nulos, dando $b_{4m+2} = \frac{4}{(2m+1)\pi}$.

- **Serie de Senos resultante:**
  $$f(x) = \sum_{m=0}^{\infty} \frac{4}{(2m+1)\pi} \operatorname{sen}\left(\frac{(4m+2)\pi x}{2}\right)$$
