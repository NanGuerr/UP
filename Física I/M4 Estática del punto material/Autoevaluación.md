...
### Enunciado
Los hombres de la figura desean levantar la caja que se halla sobre el camión. Calcular las tensiones de los cables ($ ec{T_B}$ y $ ec{T_C}$) sabiendo que la caja pesa $300\text{ kgf}$, y que los ángulos que forman los cables con la horizontal son de $50^\circ$ (cable izquierdo en el punto B) y $30^\circ$ (cable derecho en el punto C).
...
2. **Fuerzas intervinientes:**
   * $ ec{T_B}$: Tensión del cable izquierdo, formando un ángulo $\theta_B = 50^\circ$ con el semieje $x$ negativo.
   * $ ec{T_C}$: Tensión del cable derecho, formando un ángulo $\theta_C = 30^\circ$ con el semieje $x$ positivo.
   * $ ec{P}$: Peso de la caja, dirigido verticalmente hacia abajo, con valor $P = 300\text{ kgf}$.
...
* Cable $B$: $\theta_1 = 180^\circ - 50^\circ = 130^\circ$ (o trabajando directamente con las componentes rectangulares y signos explícitos).
* Cable $C$: $\theta_2 = 30^\circ$.
* Peso $ ec{P}$: $\theta_3 = 270^\circ$ (magnitud $300\text{ kgf}$).
...
De la Ecuación (1), despejamos el módulo de $ ec{T_B}$:
...
### Enunciado
Para el sistema de fuerzas de la figura, decidir si es posible encontrar un valor de $ ec{F_2}$ para que el sistema se halle en equilibrio.
* **Datos:** 
  ...
  * $ ec{F_2}$ actúa horizontalmente hacia la izquierda ($180^\circ$).
...
### Conclusión Física
Dado que la sumatoria de fuerzas en el eje vertical ($\sum F_y$) **no es cero** ($9.99\text{ kgf} \neq 0$), el sistema **no puede estar en equilibrio** bajo ninguna circunstancia, ya que la fuerza $ ec{F_2}$ (al ser estrictamente horizontal) no tiene componentes verticales para contrarrestar este desequilibrio en el eje $y$.
