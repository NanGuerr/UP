...
## 🏗️ Actividad 1: El Sistema de Cables y la Caja sobre el Camión
...
1. **⚖️ Condición de Equilibrio:** El punto de unión de los cables (punto $A$) se encuentra en reposo (equilibrio estático), por la que la resultante de todas las fuerzas concurrentes que actúan sobre él debe ser nula:
   $$\sum \vec{F} = \vec{0}$$
