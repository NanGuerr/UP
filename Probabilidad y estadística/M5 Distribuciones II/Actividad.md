# 📝 Actividad de Estadística sobre Backups 💾
...
*   **💡 Paso a paso resolutivo:**
1. **Identificación del modelo:** Se realiza el conteo de eventos discretos ("errores críticos" ⚠️) en un intervalo continuo de tiempo (semanas) ⏱️. Al tratarse de un proceso de ocurrencias independientes en el tiempo, se modela mediante una **distribución de Poisson** 🐟.
