...
| **Forma Gráfica / Simetría** | Asimétrica (sesgada a la derecha) cuando $\lambda$ es pequeño; tiende a la simetría si $\lambda$ crece . | Perfectamente simétrica en forma de campana respecto a su media $\mu$. |
...
| **Ejemplo Clásico** | Cantidad de autos que llegan a un peaje por minuto o errores en un disco de datos. | Altura de los estudiantes de una universidad o desvíos térmicos en un laboratorio. |
