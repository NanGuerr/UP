...
Bien, tenemos este archivo y con este archivo nos interesa poder elaborar una síntesis, es decir, una interpretación de hardware de esta descripción que hemos realizado. Recordemos que es una descripción que modela una compuerta AND de 8 bits. 
